"""Regression tests for the v2 integration-hardening wiring."""
...
def _seal(root: Path, plan):
    seal = seal_plan(plan, "integration", "2026-09-05T00:00:00+00:00")
...
""".strip(),
    ...
    rules = load_policy_rules_from_dir(str(policies))
    assert len(rules) == 1
